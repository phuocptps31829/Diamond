...
const features = [
  {
    ...
    image: "https://i.ibb.co/frGRBP0/Ph-ng-kh-m-hi-n-i-min.jpg",
  },
  {
    ...
    image: "https://i.ibb.co/xHjyTyq/Ph-ng-x-t-nghi-m-ti-n-ti-n-min.jpg",
  },
  {
    ...
    image: "https://i.ibb.co/202ssN7/Ph-ng-n-i-tr-tho-i-m-i-min.jpg",
  },
  {
    ...
    image: "https://i.ibb.co/PQ6g77d/Khu-v-c-ti-m-ch-ng-an-to-n-min.jpg",
  },
  {
    ...
    image: "https://i.ibb.co/FJZ7fXZ/Nh-thu-c-y-min.jpg",
  },
  {
    ...
    image: "https://i.ibb.co/bgWT9P4/Ph-ng-c-p-c-u-247-min.jpg",
  },
];
  ...
  return (
    <section className="py-3">
      <div className="container mx-auto max-w-screen-xl">
        <h2 className="my-2 text-3xl font-medium lg:text-4xl">

      ...
      <div className="mx-auto max-w-[85rem] px-4 py-5 sm:px-6 lg:px-8">
        <div className="relative mx-auto grid max-w-4xl space-y-5 sm:space-y-6">
          ...
          <div className="text-center">
            ...
            <p className="mt-3 text-base font-semibold uppercase tracking-wide text-primary-500">
          ...
          <div className="text-center sm:flex sm:items-center sm:justify-center sm:text-start">
            <div className="flex-shrink-0 pb-5 sm:flex sm:pb-0 sm:pe-5">
              ...
              <div className="flex justify-center -space-x-3">
                ...
                <span className="z-10 inline-flex h-8 w-8 items-center justify-center rounded-full bg-background ring-2 ring-muted-foreground">
            ...
            <div className="pt-5 sm:ps-5 sm:pt-0">
              <div className="text-lg font-semibold">Đánh giá khách hàng</div>
              <div className="text-sm text-muted-foreground">
                Được đánh giá 5 sao bởi hơn 10.000 bệnh nhân
              </div>
            </div>
          </div>
          {/* End Avatar Group */ }

...
export default function ContentNews({
  ...
  }, [allNews, isLoadingAllNews, news?._id, news?.specialty?._id]);
  ...
  return (
    <div className="mx-auto max-w-screen-xl p-4 md:p-5">
      <div className="flex gap-10">
        ...
        <div className="sticky w-[30%] top-28 hidden h-fit flex-col gap-3 lg:flex">
          <h2 className="border-b border-b-black p-2 text-left w-full text-xl font-bold">
            Tin tức mới
          </h2>

...
export function MedicalRecordAccordion() {
    ...
    console.log(medicalRecords?.[2]?.result);

    return (
        medicalRecords?.data?.length ? <Accordion type="single" collapsible className="w-full">
                ...
                <AccordionItem key={ record._id } value={ record._id }>
                    ...
                    <AccordionContent className="flex gap-4">
                        <div className="flex-1">
                            <h2 className="text-[17px] mb-2 font-semibold text-gray-700">Kết quả khám:</h2>
                        ...
                        { record?.prescription && (
                            <div className="flex-1">
                                <h2 className="text-[17px] font-semibold text-gray-700">Đơn thuốc:</h2>
                                <div className="rounded-md bg-[#fafdffdd]">
                                    ...
                                    <ul className="ml-4">
                                        { record.prescription.medicines.map((medicine, i) => (

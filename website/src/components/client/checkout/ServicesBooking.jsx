...
export default function Form() {
  ...
  return (
    <div className="mx-auto max-w-screen-xl px-0 py-3 md:px-5 md:py-5">
      <div className="container mx-auto flex flex-col gap-5 rounded-md border bg-white px-5 py-5 shadow-md md:flex-row">
        {/* Select Services */}
              ...
              services.map((svc) => {
                ...
                return (
                  <div className="relative py-3" key={svc.id}>
                    ...
                    />
                    <span
                      className={`absolute right-4 top-1/2 box-content block h-3 w-3 -translate-y-1/2 rounded-full border-4 border-gray-300 bg-white ${hasEmptyFields ? "peer-checked:border-red-500" : "peer-checked:border-[#0067e2]"}`}
                    >
                      <span
                        className={`absolute right-1/2 top-1/2 box-content block h-[0.5px] w-[0.5px] -translate-y-1/2 translate-x-1/2 rounded-full border-[3px] border-gray-300 border-inherit bg-white`}
                      ></span>
                    </span>
                    <label

                                    ...
                                    {imagePreview ? (
                                        <div className="">
                                            ...
                                            <button
                                                ...
                                                className="absolute right-2 top-2 rounded-sm bg-red-500 p-2 text-white"
                                            >
                                                X
                                            </button>
                                        </div>
            ...
            { DegreePreview && (
              ...
              >
                ...
                <div className="block">
                    <div className="w-full gap-[10px] md:flex">
                        ...
                        <div className="relative md:mb-4 md:w-1/2">
                            ...
                            {/* Khoa khám */}
                            <SelectDepartment control={control} name="department" errors={errors} />
                        </div>
                ...
                <div className="flex w-full gap-[10px]">
                    <div className="w-full gap-[10px] md:flex">
                        <div className="relative mb-3 md:w-1/2">
                            <label htmlFor="hoten" className="left-[15px] mb-2 block bg-white px-1">
                        ...
                        <div className="relative mb-3 md:w-1/2">
                            ...
                            <SelectBranch control={control} name="branch" errors={errors} />
                        </div>
                    </div>
                </div>
                <div className="flex w-full gap-[10px]">
                ...
                <div className="flex gap-40">
                    <div className="mt-3">
                        <Label htmlFor="" className="mb-2 block text-base text-black">
                            ...
                            render={({ field }) => (
                                ...
                                >
                                    <div className="flex items-center space-x-2">
                                        ...
                                        <Label htmlFor="r3">Bác sĩ nội</Label>
                                    </div>
                                    <div className="flex items-center space-x-2">
                                        <RadioGroupItem value={false} id="r4" />
                                        <Label htmlFor="r4">Bác sĩ ngoại</Label>
                                    </div>
                                </RadioGroup>
                            )}
                        />

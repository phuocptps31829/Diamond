...
const PackagesFormFix = ({ packageDetail }) => {
    ...
    const { mutate: updatePackageMutation, isPending } = useMutation({
        mutationFn: ({ id, requestBody }) => packageApi.updatePackage(id, requestBody),
        onSuccess: (newData) => {
    ...
    return (
        <div className="w-full">
            <div className="rounded-xl bg-white px-6 py-6">
                <h1 className="mr-2 h-fit bg-white text-2xl font-bold">Thông tin gói sản phẩm</h1>
                <form onSubmit={handleSubmit(onSubmit)}>
                    ...
                    <div className="mt-10 w-full text-end">
                        <Button variant="custom" type="submit" disabled={isPending || loadingImage}>

...
const ActionMenu = ({ row }) => {
  ...
  const { mutate: deleteMedicineMutation, isPending } = useMutation({
        ...
        <DropdownMenu>
          ...
          <DropdownMenuContent align="end" className="w-fit min-w-0">
            <DropdownMenuItem
              ...
              onClick={ () =>
                navigate(`/admin/medicines/edit/${row.original._id}`)
              }
            >
              ...
              <AlertDialog>
                ...
                <AlertDialogContent>
                  <AlertDialogHeader>
                    ...
                    <AlertDialogDescription>
                      Hành động này không thể hoàn tác. Thuốc sẽ bị xóa vĩnh
                      viễn khỏi hệ thống.
                    </AlertDialogDescription>
                  </AlertDialogHeader>
                  <AlertDialogFooter>
                    ...
                    <AlertDialogAction
                      onClick={ () => deleteMedicineMutation(row.original._id) }
                    >
                      Xóa
                    </AlertDialogAction>
                  </AlertDialogFooter>

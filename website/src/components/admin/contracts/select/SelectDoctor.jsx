...
export default function SelectDoctor({ control, name, errors, onChange }) {
  ...
  const handleClick = () => {
    if (!options.length) {
      toastUI("Không có bác sĩ nào để chọn", "warning");
      return;
    }
  };
              ...
              <PopoverContent className="popover-content-width-same-as-its-trigger p-0">
                <Command
                  filter={(doctorId, search) => {
                    ...
                    if (!doctor) return 0;
                    return doctor.fullName.toLowerCase().includes(search.toLowerCase()) ? 1 : 0;
                  }}

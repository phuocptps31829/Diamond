      ...
      <div className='container mx-auto gap-5 px-10 py-5 pb-10 border shadow-gray rounded-md'>
        <div>
          <div className='flex flex-col md:flex-row justify-between items-center my-6'>
            ...
            <span className='text-[16px] md:text-[20px] mt-4 md:mt-0'>Tổng dịch vụ: 1 dịch vụ</span>
          </div>
          <div className='flex flex-col md:flex-row justify-between text-[16px] md:text-[18px] mb-7'>
            ...
            <div className='w-full md:w-[50%]'>
              ...
              <div className='px-4 py-3 border border-primary-500 rounded-lg relative mb-3 max-w-full'>
                <div className='flex flex-col md:flex-row mb-2'>
                  <img
                    src='https://img.ykhoadiamond.com/uploads/package/12042023/57f12ac8-2eaf-4bbc-a9ed-2038d671f63a.jpg'
                    className='w-full md:w-[120px] h-auto md:h-[60px] mb-2 md:mb-0'
                    alt='Sức Khỏe Hậu COVID-19'
                  />
                  <div className='md:ml-2'>
                    <p className='font-bold text-[16px] md:text-[20px]'>SỨC KHỎE HẬU COVID-19</p>
                    <span className='text-[14px] md:text-[15px]'>Tiêu chuẩn</span>
                  </div>
                </div>
                <div>
                  ...
                  <p className='font-light text-[12px] md:text-[15px] text-justify mt-2'>

export default function UsageSteps() {
  return (
    <div className="mx-auto my-5 mt-5 max-w-screen-xl md:px-7 px-3 md:mt-10">
      <div className="lg:grid-cols-70-30 grid grid-cols-1 items-center">
        <div className="md:pr-[30px]">
          ...
          <p className="my-4 text-center text-[15px] sm:mb-10 sm:text-left text-[#646464]">
          ...
          <div className="grid grid-cols-1 gap-5 sm:grid-cols-2">
            <div className="flex items-center gap-3 rounded-2xl bg-primary-50 p-3 px-5">

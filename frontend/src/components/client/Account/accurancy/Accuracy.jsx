<<<<<<<< HEAD:frontend/src/components/client/Account/accurancy/Accurancy.jsx
              ...
              <div className="mb-2 relative">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    type="text"
                    id="authCode"
                    className="w-full px-8 md:px-10 py-3  
                    border-2 border-gray-200 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue"
                  />
                  <button
                    type="button"
...
>>>>>>>> main:frontend/src/components/client/Account/accurancy/Accuracy.jsx
